...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
			...
			},
			{
				...
				meta: {
					title: 'message.router.dormitory',
					isLink: '',
					isHide: false,
					isKeepAlive: true,
					isAffix: false,
			...
			},
			{
				path: '/pingfen',
				name: 'pingfen',
				component: () => import('/@/views/pingfen/index.vue'),
				meta: {
					title: 'message.router.pinfen',
					isLink: '',
					isHide: false,
					isKeepAlive: true,
					isAffix: false,
			...
			},
			{
				path: '/dianming',
				name: 'dianming',
				component: () => import('/@/views/dianming/index.vue'),
				meta: {
					title: 'message.router.dianming',
					isLink: '',
					isHide: false,
					isKeepAlive: true,
					isAffix: false,
