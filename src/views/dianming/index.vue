...
// 引入组件
const UserDialog = defineAsyncComponent(() => import('/@/views/dianming/dialog.vue'));
const StuDialog = defineAsyncComponent(() => import('/@/views/dianming/stuDetails.vue'));
const MgDialog = defineAsyncComponent(() => import('/@/views/dianming/mgDetails.vue'));
const PingfenDialog = defineAsyncComponent(() => import('/@/views/dianming/pingfenDetails.vue'));
const PersonalDialog = defineAsyncComponent(() => import('/@/views/dianming/personalDetails.vue'));
