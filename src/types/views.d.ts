...
declare interface SysUserState {
	...
	ruleForm: FormUserType;
}

declare type SchoolType<T = any> = {
	id: number;
	school_name: string;
}

interface SchoolTableType extends TableType {
	data: SchoolType[];
}

declare interface SchoolState {
	tableData: SchoolTableType;
}

declare type ClassType<T = any> = {
	id: number;
	class_id: string;
	class_name: string;
	tid: number;
...
interface ClassTableType extends TableType {
	data: ClassType[];
}

declare interface ClassState {
	tableData: ClassTableType;
}

declare type TeacherType<T = any> = {
	id: number;
	name: string;
	iphone: string;
	level: number;
...
interface TeacherTableType extends TableType {
	data: TeacherType[];
}

declare interface TeacherState {
	tableData: TeacherTableType;
}

declare type DormitoryType<T = any> = {
	id: number;
	building: string;
	name: string;
	storey: string;
...
interface DormitoryTableType extends TableType {
	data: DormitoryType[];
}

declare interface DormitoryState {
	tableData: DormitoryTableType;
}

declare type StudentType<T = any> = {
	id: number
	name: string,
	iphone: string,
	address: string,
	father: string,
	father_iphone: string,
	mother: string,
	mother_iphone: string,
	cid: number,
	did: number,
	sid: number,
	gender: number,
...
declare interface StudentState {
	tableData: StudentTableType;
}
